 ...
 */
	public Test06() {
		...
		//메세지 출력하고
		System.out.print("삼각형의 넓이는 1, 사각형 넓이는 2를 입력하세요.");
		// 변수에 담고
		int code = sc.nextInt();
		...
		//code값이 1이면 삼각형 넓이를 구해서 출력해주고, 2면 사각형 넓이를 구해서 출력해주세요.
		/*
		 	사각형과 삼각형의 넓이의 타입이 다르기 때문에 한가지 타입으로 통일 시켜줘야한다.
