...
public class Test08 {
	...
	public Test08() {
		...
		try {
			...
			String mail = "chopper@increpas.com";
			
			// 	DataInputStream/	DataOutputStream 의 특징은 자바의 데이터를 변환없이 사용할 수 있따.
			dout.writeUTF(name);
			dout.writeInt(age);
			...
			JOptionPane.showMessageDialog(null,"***친구 드럭 왁로***");
