...
/**
 * 	이 클래스는 회원에 관련된 데이터베이스 처리작업을 하기위한 클래스
 * @author 서동혁
 * @since 2020.04.03
 * @version v.1.0
 * 
...
public class MemberDAO {
	// 이클래스는 데이터베이스 처리 작업을 위한 클래스이므로 기본적으로
...
//			따라서 ?있는 애들을 다 채워서 보내야 하기 때문에
		// PreparedStatement가 필요할 것이다.
...
try {
	...
	//  질의 명령이 완성되었으니 보내고 변경된 행수를 반환받으면 된다.
